This fork of [apple/swift-protobuf](https://github.com/apple/swift-protobuf) updates BinaryDecoder to be public instead of internal so that it can be used to implement clients for the never-adopted twirp streaming protocol.
